...
try:
    ...
    font_slogan = ImageFont.truetype("arialbd.ttf", 35) # Slightly larger for curve
...
max_logo_size = 340 # Increased size further
w, h = logo.size
aspect_ratio = w / h
...
# 2. QR Code
qr_size = 140 # Increased size further
...
gap_logo_join = 5 # Reduced gap
gap_join_qr = 5 # Reduced gap
